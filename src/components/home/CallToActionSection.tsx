      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <Link to="/inscription" className="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <Link to="/inscription" className="bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <Link to="/inscription" className="bg-yellow-600 text-white py-2 px-4 rounded hover:bg-yellow-700">
